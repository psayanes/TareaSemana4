...
public class ListaMascotasFragment extends Fragment {
    ...
    public void inicializarListaMascotas() {
        ...
        mascotas.add(new Mascota(R.drawable.perro1, "Catty"));
        mascotas.add(new Mascota(R.drawable.perro2, "Ronny"));
        mascotas.add(new Mascota(R.drawable.perro3, "Ducke"));
        mascotas.add(new Mascota(R.drawable.perro4, "Simon"));
        mascotas.add(new Mascota(R.drawable.perro5, "Tobby"));
    }
